...
<div class="top-header">
    <div style="display:flex;align-items:center;gap:20px;">
        ...
        <div style="margin-left:auto;text-align:right;display:flex;flex-direction:column;align-items:flex-end;gap:8px;">
            <div style="background:#0B3C75;color:white;padding:14px 22px;border-radius:12px;font-weight:700;">
                Financial Dashboard
            </div>
            <div style="font-size:13px;color:#64748B;font-weight:600;">Developed by Naveen</div>
        </div>
    </div>
</div>
""", unsafe_allow_html=True)
